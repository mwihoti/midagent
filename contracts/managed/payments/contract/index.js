...
(function (PaymentType) {
  PaymentType[PaymentType['PER_CALL'] = 0] = 'PER_CALL';
  PaymentType[PaymentType['SUBSCRIPTION'] = 1] = 'SUBSCRIPTION';
  PaymentType[PaymentType['OUTCOME_BASED'] = 2] = 'OUTCOME_BASED';
...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    if (typeof(witnesses_0.escrowDetails) !== 'function') {
      throw new __compactRuntime.CompactError('first (witnesses) argument to Contract constructor does not contain a function-valued field named escrowDetails');
    }
    if (typeof(witnesses_0.subscriptionDetails) !== 'function') {
      throw new __compactRuntime.CompactError('first (witnesses) argument to Contract constructor does not contain a function-valued field named subscriptionDetails');
    }
    this.witnesses = witnesses_0;
    this.circuits = {
      createEscrow: (...args_1) => {
        if (args_1.length !== 2) {
          throw new __compactRuntime.CompactError(`createEscrow: expected 2 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
      ...
      createSubscription: (...args_1) => {
        if (args_1.length !== 2) {
          throw new __compactRuntime.CompactError(`createSubscription: expected 2 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const subId_0 = args_1[1];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(subId_0),
            alignment: _descriptor_0.alignment()
          },
          output: undefined,
          publicTranscript: [],
      ...
      revokeSubscription: (...args_1) => {
        if (args_1.length !== 2) {
          throw new __compactRuntime.CompactError(`revokeSubscription: expected 2 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const subId_0 = args_1[1];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
        ...
        const result_0 = this._revokeSubscription_0(context,
                                                    partialProofData,
                                                    subId_0);
        partialProofData.output = { value: [], alignment: [] };
        return { result: result_0, context: context, proofData: partialProofData, gasCost: context.gasCost };
    ...
    this.impureCircuits = {
      ...
      revokeSubscription: this.circuits.revokeSubscription
    };
  ...
  initialState(...args_0) {
    ...
    state_0.setOperation('revokeSubscription', new __compactRuntime.ContractOperation());
  ...
  _subscriptionDetails_0(context, partialProofData) {
    const witnessContext_0 = __compactRuntime.createWitnessContext(ledger(context.currentQueryContext.state), context.currentPrivateState, context.currentQueryContext.address);
    const [nextPrivateState_0, result_0] = this.witnesses.subscriptionDetails(witnessContext_0);
    context.currentPrivateState = nextPrivateState_0;
    if (!(result_0.buffer instanceof ArrayBuffer && result_0.BYTES_PER_ELEMENT === 1 && result_0.length === 32)) {
  ...
  _releaseEscrow_0(context, partialProofData, escrowId_0) {
  ...
  _revokeSubscription_0(context, partialProofData, subId_0) {
    __compactRuntime.assert(_descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                      partialProofData,
                                                                                      [
                                                                                       { dup: { n: 0 } },
...
const _dummyContract = new Contract({
  escrowDetails: (...args) => undefined,
  subscriptionDetails: (...args) => undefined
});
